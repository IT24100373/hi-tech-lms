...
public interface PaymentIntentRepository extends JpaRepository<PaymentIntent, Long> {
    ...
    // Find by idempotency key (prevents duplicate processing)
    Optional<PaymentIntent> findByIdempotencyKey(String key);

    // Check if a PENDING/CONFIRMED intent already exists for this student+course
    boolean existsByStudentIdAndCourseIdAndStatus(
        Long studentId, Long courseId, PaymentIntent.IntentStatus status);
}
